        ...
        <div className="min-h-screen bg-vellum-background text-vellum-on-surface font-body flex items-center justify-center p-6">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-2xl font-bold font-headline mt-4">Welcome Back</h1>
                    <p className="text-vellum-on-surface-variant text-sm mt-2 font-medium">Continue your story where you left off.</p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-end">
                            ...
                            <a href="#" className="text-[10px] font-bold uppercase tracking-widest text-vellum-primary hover:underline transition-all">Forgot?</a>
                        </div>
                        <div className="relative flex items-center">
                ...
                <div className="mt-10 pt-10 border-t border-vellum-outline/10 text-center">
                    <div className="relative mb-10">
                        <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-vellum-outline/10"></div></div>
                        <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold"><span className="bg-surface-container-low px-4 text-vellum-on-surface-variant">Or continue with</span></div>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-3 py-3 rounded-xl border border-vellum-outline/20 hover:bg-surface-container transition-all">
                        ...
                        <button className="flex items-center justify-center gap-3 py-3 rounded-xl border border-vellum-outline/20 hover:bg-surface-container transition-all">
                            <div className="w-5 h-5 bg-vellum-on-surface-variant rounded-full" />
                        </button>
                    </div>

                    <p className="mt-10 text-xs text-vellum-on-surface-variant font-medium">
                        New to Vellum? <Link to="/signup" className="text-vellum-primary font-bold hover:underline">Create an account</Link>
                    </p>
                </div>
            </motion.div>
        </div>
